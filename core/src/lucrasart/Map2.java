...
public class Map2{ 
	...
	private void update() { 
		...
		if(player.getBody().overlaps(goal)) { 
			...
			//GameScreen.map20=false;
			//GameScreen.GameMusic2.stop();
