...
public class PantallaMenu extends AbstractScreen {
	...
	public void show() {
		...
		play = new Texture(Gdx.files.internal("Menu/start1.png"));
		quit = new Texture(Gdx.files.internal("Menu/exit1.png"));
		stuff = new Texture(Gdx.files.internal("Menu/controls0.png"));
		stuffN = new Texture(Gdx.files.internal("Menu/stuff-inside.png"));
		back = new Texture (Gdx.files.internal("Menu/back.png"));
		about = new Texture(Gdx.files.internal("Menu/info.png"));
		controlsImage = new Texture (Gdx.files.internal("Menu/controls1.png"));
